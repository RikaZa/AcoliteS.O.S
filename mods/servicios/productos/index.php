...
<head>
  ...
  <title>  Colite S.O.S | Productos | </title>
      ...
      <div class="row">
        <div class="col-lg-3 tarjetas">
          ...
          <div id="imgdiv">
            ...
            <div id="textosmenu">
              <a href="../motos/index.html" style="color:white">
          ...
          <div id="imgdiv">
            ...
            <div id="textosmenu">
              <a href="../winchas/index.html" style="color:white">
          ...
          <div id="imgdiv">
            ...
            <div id="textosmenu">
              <a href="../productos/index.html" style="color:white">
          ...
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="img/Inicio/cr-1.png" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="img/Inicio/cr-2.png" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="img/Inicio/cr-3.png" class="d-block w-100" alt="...">
              </div>
            </div>
...
<main>
  <div class="container caro" id="bgdiv">
    <div class="row">
  <img src="img/NO FONDO.png" class="img">
  </div></div>
</main>
